...
export function FloatingLantern({
  delay,
  duration,
  x,
  color,
  ...
  return (
    <motion.div
      ...
      // 👇 Works on both laptop (hover) and phone (tap)
      onHoverStart={triggerSpark}
      onTapStart={triggerSpark}
    ...
    >
      ...
      >
        ...
        <ellipse cx="25" cy="20" rx="10" ry="3" fill={color} opacity="0.8" />
        <ellipse cx="25" cy="55" rx="10" ry="3" fill={color} opacity="0.7" />
        ...
        <motion.ellipse
          ...
          fill="#FFF4E6"
          opacity="0.9"
          animate={{ opacity: [0.6, 0.9, 0.6], ry: [8, 12, 8] }}
