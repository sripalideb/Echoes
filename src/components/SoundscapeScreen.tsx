  ...
  import { bells, laughs, thud_sound_effect, home_sound, classical_flute, happy_diwali, kids, diyaFlicker } from "../assets/Music";
  ...
  const soundData = [
    ...
    {
      id: 8,
      caption: "happy diwali. even miles away, you’re still part of the glow.",
      color: "#2B6F74",
      x: 70,
      y: 35,
      audioUrl: happy_diwali,
    },
    {
      id: 9,
      caption: "just a small tune-shaped hug < 3",
      color: "#B55D63",
      x: 35,
      y: 70,
      audioUrl: classical_flute,
    },
    // {
    //   id: 10,
  ...
  export function SoundscapeScreen({
    ...
    const handleOrbPlay = (id: number, audioUrl: string) => {
      // If clicking the currently playing orb, stop it
      ...
      <div className="relative w-full min-h-screen overflow-hidden">
        ...
        >
          <p
            ...
            style={{ color: "#F5E9D5" }}
          >
            Tap orbs to play/pause echoes of home
          </p>
        </motion.div>
      </div>
    );
